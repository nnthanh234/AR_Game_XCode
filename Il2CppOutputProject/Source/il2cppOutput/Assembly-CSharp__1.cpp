...
IL_00a1:
	...
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_24 = __this->___go;
		NullCheck(L_24);
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_31), (-1.20000005f), ((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply(L_29, (2500.0f))), L_30)), (10.0f), NULL);
		NullCheck(L_25);
...
IL_00e5:
	{
		bool L_32;
		L_32 = Enumerator_MoveNext_mBE785620F02FA4C9BFF31CC4A56D796BCA196F04((&V_0), Enumerator_MoveNext_mBE785620F02FA4C9BFF31CC4A56D796BCA196F04_RuntimeMethod_var);
		if (L_32)
		{
			goto IL_002c;
		}
